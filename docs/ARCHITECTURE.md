...
- `pinyin_app/pinyin_live.py` inicia los listeners globales de teclado y el ícono en la bandeja.
...
- Diálogo de configuración: captura el atajo directo desde las teclas presionadas y lo guarda en `pinyin_app/config.json`.
